  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        labelPrefixInstructions: { type: 'string' },
        mood: { type: ['string', 'null'] },
    ...
    run: (repo, a) =>
      upsertMonsterTemplate(repo, asWorldId(a.worldId as string), {
        ...
        shortDescription: a.shortDescription as string,
        longDescription: a.longDescription as string,
        hpMin: Number(a.hpMin),
        hpMax: Number(a.hpMax),
        damageMin: a.damageMin !== undefined ? Number(a.damageMin) : 1,
        damageMax: a.damageMax !== undefined ? Number(a.damageMax) : 1,
        defenseMin: a.defenseMin !== undefined ? Number(a.defenseMin) : 0,
        defenseMax: a.defenseMax !== undefined ? Number(a.defenseMax) : 0,
        labelPrefixInstructions: (a.labelPrefixInstructions as string | null) ?? null,
        mood: (a.mood as string | null) ?? null,
