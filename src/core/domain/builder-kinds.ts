...
export const ProblemKind = {
  ...
  TemplateDamageInvalid: 'template_damage_invalid',
  TemplateDamageRangeInvalid: 'template_damage_range_invalid',
  TemplateDefenseInvalid: 'template_defense_invalid',
  TemplateDefenseRangeInvalid: 'template_defense_range_invalid',
